...
<html lang="en-us">
	<head>
		<title> Thêm chuyên mục bài viết </title>
											...
											<form id="catForm" action="" method="post">
												...
												<fieldset>
													...
													<div class="form-group">
														<label>Tên chuyên mục bài viết</label>
														<input type="text" class="form-control" name="Catp_Name" value="<?=$post['Catp_Name']?>"/>
													</div>
												</fieldset>
												<fieldset>
													...
													<div class="form-group">
														<label>Thứ tự</label>
														<input type="text" class="form-control" name="Catp_Order" value="<?=$post['Catp_Order']?>" />
													</div>
												</fieldset>
